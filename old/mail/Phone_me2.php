...
if (isset($_POST['name']) && isset($_POST['phone'])){
    ...
    $result = $mysqli->query("INSERT INTO ".$db_table." (site,variant,name,phone,vu,vuv,ma,ca,va,na) VALUES ('Автопарк','2','$name','$phone','$uservu','$uservuv','$userma','$userma','$userca','$userva','$userna')");
