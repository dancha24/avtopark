...
<head>
<meta charset="utf-8">
<meta http-equiv="Refresh" content="30; url=https://xn--42-6kcpftmbw7bcj7n.xn--p1ai/">
...
$config['smtp_from'] = 'ЯндексТакси'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
...
$userna = $_POST['na'];
    ...
    $result = $mysqli->query("INSERT INTO ".$db_table." (site,variant,name,phone,vu,vuv,ma,ca,va,na) VALUES ('ЯндексТакси','1','$name','$phone','$uservu','$uservuv','$userma','$userca','$userva','$userna')");
