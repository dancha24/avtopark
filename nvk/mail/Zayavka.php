<head>
	<meta http-equiv="Refresh" content="10; url=http://xn--42-6kcaj3c0aikq.xn--p1ai/">
	<link href="../css/bootstrap.css" rel="stylesheet">
<!-- Global site tag (gtag.js) - Google Ads: 832323453 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-832323453"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'AW-832323453');
</script>
<!-- Event snippet for Заявка с Автопарка conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-832323453/Pvv5CMj9yJMBEP3-8IwD'});
</script>
...
$msg .= "<p><strong>Серия и номер ВУ:</strong> ".$uservu."</p>\r\n";
$msg .= "<p><strong>Дата выдачи ВУ:</strong> ".$uservuv."</p>\r\n";
$msg .= "<p><strong>Марка автомобиля:</strong> ".$userma."</p>\r\n";
$msg .= "<p><strong>Цвет автомобиля:</strong> ".$userca."</p>\r\n";
$msg .= "<p><strong>Год выпуска автомобиля:</strong> ".$userva."</p>\r\n";
$msg .= "<p><strong>Гос. номер автомобиля:</strong> ".$userna."</p>\r\n";
$msg .= "</body></html>";
...
if (isset($_POST['name']) && isset($_POST['phone'])){
	...
	$db_host = "sql169.main-hosting.eu"; 
    ...
    $result = $mysqli->query("INSERT INTO ".$db_table." (site,variant,name,phone,vu,vuv,ma,ca,va,na,checkit) VALUES ('Автопарк','$variant','$name','$phone','$uservu','$uservuv','$userma','$userca','$userva','$userna','0')");
